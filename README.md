...
Quản lý sự kiện hackathon theo mùa Spring/Summer/Fall.
Quản lý vòng thi, hạn nộp bài, vòng hiệu chuẩn và quy tắc Top N thăng vòng.
Quản lý hạng mục thi đấu và mentor.
Quản lý mẫu tiêu chí, tiêu chí theo sự kiện, điểm tối đa và trọng số.
Quản lý đội thi 3–5 thành viên và trạng thái phê duyệt.
Nộp bài theo vòng bằng URL repository, demo, báo cáo/slide.
Quản lý tài khoản, phê duyệt sinh viên và tạo tài khoản mentor/giám khảo/giám khảo khách mời.
Phân công giám khảo theo vòng thi và hạng mục.
Tính xếp hạng, xét thăng vòng và hiển thị đội dự kiến vào vòng tiếp theo.
Loại bài nộp vi phạm quy chế và ghi nhật ký kiểm tra.
Quản lý giải thưởng, thông báo và công bố thông tin đến người tham gia.
Dashboard RBL: phương sai điểm giữa giám khảo, độ đầy đủ chấm điểm và xuất CSV ẩn danh.
Quên mật khẩu: tạo mã đặt lại có thời hạn 15 phút và cập nhật mật khẩu mới.
Dashboard bổ sung thao tác phân công mentor, thêm thành viên đội và chấm điểm trực tiếp theo tiêu chí.
